...
func (engine *Engine) LoadHTMLGlobNoSVN(pattern string) {
	...
	for _, v := range filenames {
		if !strings.Contains(v, ".svn") && !strings.Contains(v, "/.") {
			filterfilenames = append(filterfilenames, string(v))
		}
	}
	templ := template.Must(template.ParseFiles(filterfilenames...))
