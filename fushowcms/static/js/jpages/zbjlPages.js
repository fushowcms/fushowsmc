		...
		bindEvent:function(obj,args){
			return (function(){
				obj.on("click","a.tcdNumber",function(){
					...
					reqAjax("/user/getanchortime",{UID:args.id,page:current,rows:20},function(msg) {
						localStorage.setItem("zbjlpage",current);
						$(".removediv").remove();
				...
				obj.on("click","a.prevPage",function(){
					...
					reqAjax("/user/getanchortime",{UID:args.id,page:current-1,rows:20},function(msg) {
						localStorage.setItem("zbjlpage",current-1);
						$(".removediv").remove();
