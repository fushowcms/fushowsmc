		...
		bindEvent:function(obj,args){
			return (function(){
				obj.on("click","a.tcdNumber",function(){
					...
					reqAjax("/page/selroomalias",{page:current,rows:1},function(msg) {
						localStorage.setItem("cxzbpage",current);
				...
				obj.on("click","a.prevPage",function(){
					...
					var url = "/page/selroomalias";   
					reqAjax("/page/selroomalias",{page:current,rows:1},function(msg) {
						localStorage.setItem("cxzbpage",current-1);
						window.location.reload();
					});
