...
$(function() {
	...
	// 复制功能
	var clip = new ZeroClipboard(document.getElementById("key_button1"), {
		moviePath: "/static/js/room/ZeroClipboard.swf"
	});
	var clip = new ZeroClipboard(document.getElementById("key_button2"), {
		moviePath: "/static/js/room/ZeroClipboard.swf"
	});
	var clip = new ZeroClipboard(document.getElementById("key_button3"), {
		moviePath: "/static/js/room/ZeroClipboard.swf"
	});
