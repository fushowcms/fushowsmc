...
! function() {
	...
	var a, b = function() {
		...
		c = function(a, c) {
			var d, e, f, g, h, i;
			if(window.getComputedStyle ? d = window.getComputedStyle(a, null).getPropertyValue(c) : (e = b(c), d = a.currentStyle ? a.currentStyle[e] : a.style[e]), "cursor" === c && (!d || "auto" === d))
				for(f = a.tagName.toLowerCase(), g = ["a"], h = 0, i = g.length; i > h; h++)
					if(f === g[h]) return "pointer";
			return d
		},
		d = function(a) {
	...
	p.prototype.resetBridge = function() {
		...
		for(var b = 0; b < a.length; b++) {
			f(a[b], "mouseover", d);
			var c = m(a[b], q); - 1 != c && q.splice(c, 1)
		}
