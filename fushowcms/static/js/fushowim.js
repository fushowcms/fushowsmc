...
//    	    	break;
   ...
   ClientImpl.prototype.getTraceLog = function () {
    ...
    ClientImpl.prototype.store = function(prefix, wireMessage) {
    	...
    	setStorage(prefix+this._localKey+wireMessage.messageIdentifier, JSON.stringify(storedMessage));
    };
        ...
        switch(wireMessage.type) {
            case MESSAGE_TYPE.CONNACK:
            	...
            	if (this.connectOptions.cleanSession) {
    		    	for (key in this._sentMessages) {	    		
    					...
    					removeStorage("Sent:"+this._localKey+sentMessage.messageIdentifier);
    		    	}
    				this._sentMessages = {};

    				for (key in this._receivedMessages) {
    					var receivedMessage = this._receivedMessages[key];
    					removeStorage("Received:"+this._localKey+receivedMessage.messageIdentifier);
    				}
    				this._receivedMessages = {};
            	}
            ...
            case MESSAGE_TYPE.PUBACK:
            	...
            	if (sentMessage) {
                    ...
                    removeStorage("Sent:"+this._localKey+wireMessage.messageIdentifier);
            ...
            case MESSAGE_TYPE.PUBREL:
                ...
                removeStorage("Received:"+this._localKey+wireMessage.messageIdentifier);
